  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Custom web development services designed to help your business grow online with modern, responsive, and SEO-optimized websites." />
      </Helmet>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-secondary-600">
                Quick delivery without compromising quality, getting your website live and generating results faster.
              </p>
            </motion.div>
